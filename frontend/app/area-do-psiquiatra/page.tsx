          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-7xl mx-auto border border-emerald-100">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10 justify-items-center">
              ...
              <div className="w-full bg-indigo-700 rounded-2xl p-8 shadow text-white text-center border border-indigo-700">
                ...
                <div className="text-4xl font-extrabold tracking-widest">R$ {consultasData.reduce((acc, c) => acc + (c.valor_recebido_profissional || 0), 0).toFixed(2)}</div>
              ...
              <div className="w-full bg-red-600 rounded-2xl p-8 shadow text-white text-center border border-red-600">
                ...
                <div className="text-4xl font-extrabold tracking-widest">R$ {consultasData.filter(c => c.status === 'cancelado').reduce((acc, c) => acc + (c.valor_recebido_profissional || 0), 0).toFixed(2)}</div>
